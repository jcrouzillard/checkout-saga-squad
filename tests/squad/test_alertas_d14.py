...
class Compatibilidade(unittest.TestCase):
    ...
    def test_api_state_e_live_por_http(self):
        ...
        try:
            ...
            # D24 (ADR-025, contrato publicacao-do-squad-control §4.3/§4.5): `publication` também (null sem supervisor).
            self.assertEqual(set(live) - {"testEnv", "publication"}, {"now", "version", "serverMs", "thresholds", "summary", "alerts", "agents"})
